...
const TYPE_LAYOUT: {
	...
	[FFIType.ptr]: { size: 8, align: 8 }, // if 64-bit system
	[FFIType.cstring]: { size: 8, align: 8 }, // equiv to char*
	[FFIType.function]: { size: 8, align: 8 },
	[FFIType.buffer]: { size: 8, align: 8 },
	[FFIType.napi_env]: { size: 8, align: 8 },
	[FFIType.napi_value]: { size: 8, align: 8 },
